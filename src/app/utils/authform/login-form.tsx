    ...
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-6xl">
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8 md:p-12 relative">
                ...
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400 text-lg font-bold">
                    Login to continue winning big! 🎰
                  </p>
                </div>

                {/* Bonus Banner */}
                <div className="mb-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-4 border-2 border-green-400 shadow-lg shadow-green-500/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Trophy className="w-6 h-6 text-white animate-bounce" />
                      <div>
                        <div className="text-white font-black text-sm">WELCOME BONUS</div>
                        <div className="text-white font-bold text-xs">200% up to $1000!</div>
                      </div>
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-sm">
                      <span className="px-4 bg-black text-gray-400 font-bold uppercase">Or continue with</span>
                    </div>
                  </div>
              ...
              <div className="relative bg-gradient-to-br from-purple-900 via-pink-900 to-orange-900 p-12 hidden md:flex flex-col justify-center items-center overflow-hidden">
                ...
                <div className="relative z-10 text-center space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <div className="text-white font-black text-lg">2,500+ Games</div>
                          <div className="text-white/80 text-sm">Slots, Table Games & More</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <div className="text-white font-black text-lg">$12M+ Jackpots</div>
                          <div className="text-white/80 text-sm">Win Life-Changing Prizes</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-black/30 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <div className="text-white font-black text-lg">Instant Withdrawals</div>
                          <div className="text-white/80 text-sm">Get Your Winnings Fast</div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-6">
                    <div className="inline-block bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-6 py-3 rounded-full font-black text-lg animate-pulse border-2 border-white shadow-xl">
        ...
        <div className="text-center text-gray-500 text-xs mt-6 max-w-2xl mx-auto">
          ...
          <span className="block mt-2 text-yellow-400 font-bold">🔞 18+ Only | Gamble Responsibly</span>
        </div>
      </div>
