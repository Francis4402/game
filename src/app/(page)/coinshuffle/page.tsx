...
export default function CoinShuffleGame() {
                ...
                {gameState === 'betting' && (
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-end">
                      <Button
                        onClick={placeBet}
                        className="w-full h-14 text-2xl font-black rounded-xl shadow-xl border-4 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 hover:from-purple-700 hover:via-pink-700 hover:to-blue-700 border-purple-400 shadow-purple-500/50 hover:scale-105 transition-all"
                      >
