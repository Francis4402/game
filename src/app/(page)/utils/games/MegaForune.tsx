...
export default function SlotMachineGame({session}: {session: any}) {
            ...
            <div className="space-y-4">
              ...
              {/* Spin Button */}
              {
                session ? (
                  ...
                  className={`w-full text-3xl font-black text-white py-10 rounded-2xl shadow-2xl border-4 transition-all ${
                ...
                {spinning ? (
                  ...
                  onClick={handleNavigation}
                    className={`w-full text-3xl text-white font-black py-10 rounded-2xl shadow-2xl border-4 transition-all bg-gradient-to-r from-green-500 via-emerald-600 to-green-600 hover:from-green-600 hover:via-emerald-700 hover:to-green-700 border-green-400 shadow-green-500/50 hover:scale-105`}
                  >
                      <span className="flex items-center justify-center gap-3">
                        <Zap className="w-10 h-10" />
                        SPIN TO WIN!
